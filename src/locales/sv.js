...
const sv = {
  ...
  betOverview: {
    ...
    resultat:       'Resultat',
    väntar:         'Väntar',
    rättResultat:   'Rätt resultat',
    rättSvar:       'Rätt svar',
    tips:           'tips',
    svar:           'svar',
    ingaTips:       'Inga tips lagda.',
    ...
    ingaMatcher:    'Inga matcher för det här filtret.',
    ingenData:      'Inget att visa än.',
    laddar:         'Laddar översikt...',
    fel:            'Kunde inte hämta översikten. Kontrollera din anslutning och försök igen.',
    försökIgen:     'Försök igen',
    låst: {
      titel: 'Öppnas när tipsen låsts',
      beskr: 'Bettingöversikten visas när gruppspelets tipsdeadline har passerat.',
    },
  },
