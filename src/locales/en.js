...
const en = {
  ...
  betOverview: {
    ...
    gruppspel:      'Group stage',
    tilläggsfrågor: 'Bonus questions',
    grupp:          'Group',
    resultat:       'Result',
    väntar:         'Pending',
    rättResultat:   'Correct score',
    rättSvar:       'Correct answer',
    tips:           'picks',
    svar:           'answers',
    ingaTips:       'No picks made.',
    ...
    ingaMatcher:    'No matches for this filter.',
    ingenData:      'Nothing to show yet.',
    laddar:         'Loading overview...',
    fel:            'Could not load the overview. Check your connection and try again.',
    försökIgen:     'Try again',
    låst: {
      titel: 'Opens when picks lock',
      beskr: 'The betting overview appears once the group-stage pick deadline has passed.',
    },
  },
