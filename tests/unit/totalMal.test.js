 ...
 *
 * Tester för mål-räknarens logik (startsidans "Mål totalt" + betting-översikten).
 *
 * Princip (FIFA-officiellt): räkna ordinarie + förlängning + straffar i spel,
 * men EXKLUDERA straffläggning (shootout). Skiljer sig medvetet från Resultat-
 * arket/poängräkningen på matchnivå, som bara sparar 90-min-resultatet.
 */
...
describe('målIMatch', () => {
  ...
  it('EXTRA_TIME: förlängningsmål räknas som riktiga mål', () => {
    // 0-0 efter 90, 1-0 efter förlängning → 1 riktigt mål.
    expect(målIMatch(match({
      duration: 'EXTRA_TIME',
