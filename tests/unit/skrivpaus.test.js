 ...
 * 09:00–18:00 CEST (= 07:00–16:00 UTC). I fönstret görs inga skrivningar till
...
describe('ärSkrivpaus', () => {
  it('pausar i fönstret 07:00–15:59 UTC (09–18 CEST)', () => {
    expect(ärSkrivpaus(utcHour(7))).toBe(true)   // 09:00 CEST
  ...
  it('skriver utanför fönstret (kväll/natt/morgon)', () => {
    ...
    expect(ärSkrivpaus(utcHour(6))).toBe(false)  // strax före fönstret
  })

  it('är inklusiv vid 07:00 och exklusiv vid 16:00 UTC', () => {
    expect(ärSkrivpaus(new Date(Date.UTC(2026, 5, 13, 7, 0, 0)))).toBe(true)
